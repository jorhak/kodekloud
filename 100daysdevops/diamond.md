...
**OPCION 1**
Lo primero que vamos hacer sera actualizar los plugins y instalar los plugins necesarios: **SSH**, **SSH Build Agent**, **Pipeline**, **Pipeline: GitHub Groovy Libraries**.
