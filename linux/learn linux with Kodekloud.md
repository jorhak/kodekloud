...
1. Verificar zona y hora actual:
```
timedatectl
```

2. Listar las zonas disponibles:
```
timedatectl list-timezones | grep America/Maceio
```
...
2. Limitar la cantidad de procesos maximo
```
